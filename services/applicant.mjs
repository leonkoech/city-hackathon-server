...
import { create_applicants_firebase } from "./firebase.mjs";
...
const names = [
  ...
  function generateRandomApplicants(numberOfRandomApplicants){
    const applicants = [];
  ...
  export async function create_applicants(applicantNumber){
    const applicants = generateRandomApplicants(applicantNumber);
    return await create_applicants_firebase(applicants)
  }
